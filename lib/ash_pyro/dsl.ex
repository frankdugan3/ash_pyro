defmodule AshPyro.Dsl do
  ...
  use Spark.Dsl.Extension,
    sections: [
      %Spark.Dsl.Section{
        describe: "Configure the appearance of data tables in the `AshPyro.Dsl` extension.",
        # quokka:sort
        entities: [
          AshPyro.DataTable.Action.__entity__(),
          AshPyro.DataTable.ActionType.__entity__()
        ],
        name: :data_table,
        # quokka:sort
        schema: [
      ...
      %Spark.Dsl.Section{
        describe: "Configure the appearance of forms in the `AshPyro.Dsl` extension.",
        # quokka:sort
        entities: [
          AshPyro.Form.Action.__entity__(),
          AshPyro.Form.ActionType.__entity__()
        ],
        name: :form,
        # quokka:sort
        schema: [
